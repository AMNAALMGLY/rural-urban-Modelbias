...
def main(args):
    ...
    batcher_train = Batcher(paths_train[:5000], args.scaler_features_keys, args.ls_bands, args.nl_band, args.label_name,
                            args.nl_label, 'DHS',args.augment, args.clipn, args.batch_size, groupby=args.group,
                            cache=False,shuffle=True)

    batcher_valid = Batcher(paths_valid[:2000], args.scaler_features_keys, args.ls_bands, args.nl_band, args.label_name,
