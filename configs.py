...
args = Namespace(
    ...
    lr=.01,                                                                                  #lr0001         #0.0001 nl,ms
    fc_reg=0.001,                #fc01_conv01_lr0001        fc001_conv001_lr0001       fc001_conv001_lr001   fc001_conv001_lr01       fc01_conv01_lr001
    conv_reg=0.001,
   ...
   include_buildings=True,
    ...
    seed=123,
    experiment_name='DHS_OOC_D_ms_samescaled_b',
