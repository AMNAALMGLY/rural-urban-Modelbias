...
args = Namespace(
    ...
    data_path= '/atlas/u/erikrozi/bias_mitigation/africa_poverty_clean/data/dhs_buildings',#'/atlas/u/erikrozi/bias_mitigation/africa_poverty_clean/data/dhs_tfrecords',
    ...
    seed=123,
    experiment_name='DHS_OOC_E_nl_random',
